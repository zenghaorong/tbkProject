 ...
 */
public class AebizShiroFilter extends AbstractShiroFilter {
    ...
    protected AebizShiroFilter(WebSecurityManager webSecurityManager, FilterChainResolver resolver) {
