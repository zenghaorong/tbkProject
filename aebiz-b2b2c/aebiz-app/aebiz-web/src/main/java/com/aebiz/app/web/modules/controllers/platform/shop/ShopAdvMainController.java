...
@Controller
@RequestMapping("/platform/shop/adv/main")
public class ShopAdvMainController {
    ...
    @RequestMapping("")
    @RequiresPermissions("platform.shop.adv.main")
	public String index() {
		return "pages/platform/shop/adv/main/index";
	}
    ...
    public String add(HttpServletRequest req) {
    	...
    	return "pages/platform/shop/adv/main/add";
    }

    @RequestMapping("/addDo")
    @SJson
    @SLog(description = "Shop_adv_main")
    @RequiresPermissions("platform.shop.adv.main.add")
    ...
    public String edit(@PathVariable String id,HttpServletRequest req) {
		...
		return "pages/platform/shop/adv/main/edit";
    }

    @RequestMapping("/editDo")
    @SJson
    @SLog(description = "Shop_adv_main")
    @RequiresPermissions("platform.shop.adv.main.edit")
    ...
    @SJson
    @SLog(description = "Shop_adv_main")
    @RequiresPermissions("platform.shop.adv.main.delete")
	...
	public String detail(@PathVariable String id, HttpServletRequest req) {
        ...
        return "pages/platform/shop/adv/main/detail";
    }
    /**
     * 广告管理排序
     *
