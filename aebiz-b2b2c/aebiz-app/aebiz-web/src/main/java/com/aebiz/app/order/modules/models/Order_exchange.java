...
public class Order_exchange extends BaseModel implements Serializable {
    ...
    @Comment("状态")
    @ColDefine(type = ColType.INT)
    // 配送单据状态(0等待 1成功 2失败 3取消 4丢失 5进程中) 参见OrderSSendStatusEnum
    ...
    // 换货详情
    @One(target = Order_exchange_detail.class, field = "id", key = "exchangeId")
    private Order_exchange_detail orderExchangeDetail;
    ...
    public Order_exchange_detail getOrderExchangeDetail() {
        return orderExchangeDetail;
    }

    public void setOrderExchangeDetail(Order_exchange_detail orderExchangeDetail) {
        this.orderExchangeDetail = orderExchangeDetail;
    }
}
