 ...
 */
@Table("member_account_money")
@TableIndexes({@Index(name = "INDEX_MEMBER_ACC_MONEY", fields = {"accountId"}, unique = false)})
public class Member_account_money extends BaseModel implements Serializable {
