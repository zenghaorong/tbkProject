...
public class Order_delivery extends BaseModel implements Serializable {
    ...
    @ColDefine(type = ColType.INT)
    @Default("0")
    private Integer expressStatus;//OrderExpressStatusEnum
    ...
    @Many(target = Order_delivery_detail.class, field = "deliveryId")
    private List<Order_delivery_detail> detailList;
    ...
    public List<Order_delivery_detail> getDetailList() {
        return detailList;
    }

    public void setDetailList(List<Order_delivery_detail> detailList) {
