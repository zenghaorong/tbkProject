 ...
 */
@Controller
@RequestMapping("/store/goods/list")
public class StoreGoodsListController {
    ...
    public String index(HttpServletRequest req) {
        ...
        return "pages/store/goods/list/index";
    }
    ...
    public String draftIndex(HttpServletRequest req) {
        ...
        req.setAttribute("brandList", goodsBrandService.query(Cnd.NEW()));
        req.setAttribute("tagList", goodsTagService.query(Cnd.NEW()));
        return "pages/store/goods/list/draft";
    }
    ...
    public String trashIndex(HttpServletRequest req) {
        ...
        req.setAttribute("brandList", goodsBrandService.query(Cnd.NEW()));
        req.setAttribute("tagList", goodsTagService.query(Cnd.NEW()));
        return "pages/store/goods/list/trash";
    }
    ...
    public String edit(@PathVariable(value = "type", required = false)String type, @PathVariable("id")String id, HttpServletRequest req) {
        ...
        Goods_main goods = goodsService.fetch(Cnd.where("id", "=", id).and("storeId", "=", StringUtil.getStoreId()));
        ...
        return "pages/store/goods/list/edit";
    }
    ...
    public Object upDo(@PathVariable("id") String id, HttpServletRequest req){
        try {
            goodsService.updown(id, true, StringUtil.getStoreId());
    ...
    public Object downDo(@PathVariable("id") String id, HttpServletRequest req){
        try {
            goodsService.updown(id, false, StringUtil.getStoreId());
            return Result.success("globals.result.success");
        } catch (Exception e) {
            return Result.error("globals.result.error");
        }
    ...
    @SJson
    @RequiresPermissions("store.goods.manager.goods.edit")
    @SLog(description = "商品批量上架")
    public Object upsDo(@RequestParam("ids") String[] ids){
        try {
            goodsService.updowns(ids, false, StringUtil.getStoreId());//StringUtil.getStoreUid()
            return Result.success("globals.result.success");
        } catch (Exception e) {
            return Result.error("globals.result.error");
        }
    ...
    public Object downsDo(@RequestParam("ids") String[] ids){
        try {
            goodsService.updowns(ids, false, StringUtil.getStoreId());
            return Result.success("globals.result.success");
        } catch (Exception e) {
            return Result.error("globals.result.error");
        }
    ...
    @RequiresPermissions("store.goods.manager.goods.delete")
    public Object delete(@PathVariable String id, HttpServletRequest req) {
        try {
            goodsService.vDeleteGoods(id, StringUtil.getStoreId());
            return Result.success("globals.result.success");
        } catch (Exception e) {
            return Result.error("globals.result.error");
        }
    ...
    public Object delete(@RequestParam("ids") String[] ids, HttpServletRequest req) {
        try {
            goodsService.vDeleteGoods(ids, StringUtil.getStoreId());
            return Result.success("globals.result.success");
        } catch (Exception e) {
            return Result.error("globals.result.error");
        }
    ...
    public String detail(@PathVariable String id, @PathVariable(value = "type", required = false) String type, HttpServletRequest req) {
        ...
        req.setAttribute("productsList", productsList);
        req.setAttribute("obj", goods);
        return "pages/store/goods/list/detail";
    }
    ...
    public String getChecklog(@PathVariable("id")String id, HttpServletRequest req) {
        ...
        return "pages/store/goods/list/checklog";
    }
    ...
    public Object classes(@PathVariable(value = "pid", required = false) String pid) {
        return storeMainService.getSubGoodsClasses(StringUtil.getStoreId(), pid);//StringUtil.getStoreUid()
    }
    ...
    public Object classTree() {
        //取授权分类树
        Store_main store = storeMainService.fetchLinks(storeMainService.fetch(StringUtil.getStoreId()), "goodsClasses", Cnd.where("delFlag", "=", false));
